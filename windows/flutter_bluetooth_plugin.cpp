#include "include/flutter_bluetooth/flutter_bluetooth_plugin.h"
...
void FlutterBluetoothPlugin::RegisterWithRegistrar(
  ...
  auto channel =
      std::make_unique<flutter::MethodChannel<flutter::EncodableValue>>(
          registrar->messenger(), "flutter_bluetooth",
...
void FlutterBluetoothPluginRegisterWithRegistrar(
    FlutterDesktopPluginRegistrarRef registrar) {
  FlutterBluetoothPlugin::RegisterWithRegistrar(
